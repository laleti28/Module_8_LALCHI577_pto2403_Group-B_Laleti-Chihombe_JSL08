...
//    - Return the `bankBranchInstance` whether it's newly created or existing.
    ...
    if (!bankBranchInstance) {bankBranchInstance = this;
...
let branchA = new BankBranch({ name: 'Branch A', location: 'kingston' });
let branchB = new BankBranch({ name: 'Branch B', location: 'Los Angeles' });
console.log(branchA.getBranchInfo()); // Output: { name: 'Branch A', location: 'Kingston' }
